...
/* user/show.html.twig */
class __TwigTemplate_9fd596898c4fae59e3c68b75575c6e4e3a4429c16c9b9a9571b3f3d5669f9af6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 29
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 29, $this->source); })()), "website", [], "any", false, false, false, 29), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Detalles</th>
                <td>";
        // line 33
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 33, $this->source); })()), "details", [], "any", false, false, false, 33), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
<body class=\"text-center\">
    ...
    <a href=\"{{ path('user_index') }}\">Ver listado</a>

    <a href=\"{{ path('user_edit', {'id': user.id}) }}\">Editar</a>

    {{ include('user/_delete_form.html.twig') }}
{% endblock %}
", "user/show.html.twig", "/home/cabox/workspace/my_blog_sexy/blog/templates/user/show.html.twig");
    }
}
