...
class __TwigTemplate_6292d0e699d1962a2a326a19ef71d36d36cc99f9989c168dbfa8208b8b022a4c extends Template
{
    private $source;
    private $macros = [];
  ...
  <br>
    <button class=\"w-10 btn btn-primary btn-lg\">";
        // line 4
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Crear")) : ("Crear")), "html", null, true);
        echo "</button>
";
        // line 5
...
";
    ...
    {{ form_widget(form) }}
  <br>
    <button class=\"w-10 btn btn-primary btn-lg\">{{ button_label|default('Crear') }}</button>
{{ form_end(form) }}
", "article/_form.html.twig", "/home/cabox/workspace/my_blog_sexy/blog/templates/article/_form.html.twig");
    }
}
