...
class __TwigTemplate_7bde420251fede86d5d8995323e2b7a37cfd4ab57ac1c13bbb3a57c25e276b84 extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"w-10 btn btn-primary btn-lg\">";
        // line 3
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Crear")) : ("Crear")), "html", null, true);
        echo "</button>
";
        // line 4
...
{{ form_end(form) }}
", "user/_form.html.twig", "/home/cabox/workspace/my_blog_sexy/blog/templates/user/_form.html.twig");
    }
}
