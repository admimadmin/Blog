...
class __TwigTemplate_70acba885676f159f290d3719ff515d50b7de9c09f572dd2a329254765c14ec9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <button class=\"w-10 btn btn-primary btn-lg\">";
        // line 6
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 6, $this->source); })()), "Enviar")) : ("Enviar")), "html", null, true);
        echo "</button>
";
        // line 7
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"w-10 btn btn-primary btn-lg\">{{ button_label|default('Enviar') }}</button>
{{ form_end(form) }}

</div>
</div>", "contacto/_form.html.twig", "/home/cabox/workspace/my_blog_sexy/blog/templates/contacto/_form.html.twig");
    }
}
