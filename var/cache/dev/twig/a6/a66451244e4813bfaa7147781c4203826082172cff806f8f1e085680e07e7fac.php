...
class __TwigTemplate_b788db7c10a2cddfd2d0fd1ed253cd13346148fc27b17b7fb05257a12d03cb92 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Esta seguro que desea borrar el usuario?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Esta seguro que desea borrar el usuario?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"w-10 btn btn-primary btn-lg\">Borrar</button>
</form>
", "user/_delete_form.html.twig", "/home/cabox/workspace/my_blog_sexy/blog/templates/user/_delete_form.html.twig");
    }
}
